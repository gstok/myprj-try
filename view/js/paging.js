	...
	Paging.prototype = {
		init: function(settings) {
			this.settings = $.extend({
				...
				pagesize: 10,
				current: 1,
				prevTpl: '<i class="icon icon-before"></i>',
				nextTpl: '<i class="icon icon-later"></i>',
				firstTpl: '<i class="icon icon-diyiye"></i>',
				lastTpl: '<i class="icon icon-zuihouye"></i>',
				ellipseTpl: "...",
				toolbar: false,
				hash:true,
		...
		bindToolbar: function() {
			var _this = this;
			var html = $('<li class="ui-paging-toolbar"><select class="ui-select-pagesize"></select><input type="text" class="ui-paging-count"/><a href="javascript:void(0)">go</a></li>');
