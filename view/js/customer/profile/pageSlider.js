...
;(function($, window, document, undefined) {
	...
	PageSlider.prototype.showSec = function(index, direction) {
		...
		switch (cur) {
			case 1:
				$(".sec1").find(".stage").addClass('bounceInUp');
				$(".sec1").find(".fill-datum, .personimg").addClass('fadeInDownBig');
				setTimeout(function(){
					/*$(".sec1").find(".shadow").animate({height:"0.64rem"},500);
					$(".sec1").find(".lighting").animate({height:"2.57rem"},1000);*/
					$(".sec1").find(".shadow").show(1500);
					$(".sec1").find(".lighting").show(1500);
				},1800);
				$(".sec2").find(".basicDataBox").removeClass('zoomIn').hide();
				break;
			case 2:
				$(".sec1").find(".stage").removeClass('bounceInUp');
				$(".sec1").find(".fill-datum, .personimg").removeClass('fadeInDownBig');
				$(".sec1").find(".shadow").hide();
				$(".sec1").find(".lighting").hide();
				$(".sec2").find(".basicDataBox").show().addClass('zoomIn');
				$(".sec3").find(".customerValueBox").removeClass('flipInX').hide();
				break;
			case 3:
				$(".sec2").find(".basicDataBox").removeClass('zoomIn').hide();
				$(".sec3").find(".customerValueBox").show().addClass('flipInX');
				$(".sec4").find(".buyChannelBox").hide().removeClass('flipInY');
				break;
			case 4:
				$(".sec3").find(".customerValueBox").removeClass('flipInX').hide();
				$(".sec4").find(".buyChannelBox").show().addClass('flipInY');
				$(".sec5").find(".vitalityBox").addClass('rollIn').hide();
				break;
			case 5:
				$(".sec4").find(".buyChannelBox").removeClass('flipInY').hide();
				$(".sec5").find(".vitalityBox").addClass('rollIn').show();
				$(".sec6").find(".recommendBox").removeClass('rotateIn').hide();
				break;
			case 6:
				$(".sec5").find(".vitalityBox").removeClass('rollIn').hide();
				$(".sec6").find(".recommendBox").addClass('rotateIn').show();
				$(".sec7").find(".spreadBox").removeClass('swing').hide();
				break;
			case 7:
				$(".sec6").find(".recommendBox").removeClass('rollIn').hide();
				$(".sec7").find(".spreadBox").addClass('swing').show();
				$(".sec8").find(".interactBox").removeClass('zoomInUp').hide();
				break;
			case 8:
				$(".sec7").find(".spreadBox").removeClass('swing').hide();
				$(".sec8").find(".interactBox").addClass('zoomInUp').show();
				break;
			default:
				$(".sendWeChartBox .popBox").addClass("Send4");
				break;
		}
