...
setTimeout(function(){
    $(".pointBox1 .line1Bg").animate({right:"26px"},500,function(){
        $(".pointBox1 .line2").show().animate({width:"20px"},500)
    });
},500);
//折线2动画
setTimeout(function(){
    $(".pointBox2 .line1Bg").animate({left:"43px"},500,function(){
        $(".pointBox2 .line2").show().animate({width:"20px"},500)
    });
},1000);
//折线3动画
setTimeout(function(){
    $(".pointBox3 .line1Bg").animate({left:"26px"},500,function(){
        $(".pointBox3 .line2").show().animate({width:"20px"},500)
    });
},1500);
//折线4动画
setTimeout(function(){
    $(".pointBox4 .line1Bg").animate({right:"10px"},500,function(){
        $(".pointBox4 .line2").show().animate({width:"15px"},500)
    });
},2000);
//折线5动画
setTimeout(function(){
    $(".pointBox5 .line1Bg").animate({left:"27px"},500,function(){
        $(".pointBox5 .line2").show().animate({width:"50px"},500)
    });
},2500);
//折线6动画
setTimeout(function(){
