...
//提出框
function dcrmAlertWarning(txt){
	 window.wxc.xcConfirm(txt, window.wxc.xcConfirm.typeEnum.warning);
}
//错误信息提示
function dcrmAlertError(txt){
	window.wxc.xcConfirm(txt, window.wxc.xcConfirm.typeEnum.error);
}
//成功信息提示信息提示
function dcrmAlertSuccess(txt){
	window.wxc.xcConfirm(txt, window.wxc.xcConfirm.typeEnum.success);
}
//询问框
function dcrmConfirm(txt,callback){
	window.wxc.xcConfirm(txt, window.wxc.xcConfirm.typeEnum.confirm,{onOk:callback});
}