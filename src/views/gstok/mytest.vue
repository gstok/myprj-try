...
<script>
    ...
    //页面级组件
    import GTagTip from '../customer/tagTip.vue';//表格--标签
    import ListOpt from '../customer/listOpt';//操作
    import UserName from '../customer/userName';//客户姓名
    import Gstage from '../customer/stage';
